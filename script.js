...
function StopMykeypress() {
  ...
  sendtelegram(`${userName} ${userSecond} sekund vaqt davomida, ${AnswerTrue} ta to'g'ri va ${AnswerFalse} ta xato bajardi`);
  document.querySelector('.info').innerHTML = `${userName} ${userSecond} sekund vaqt davomida, ${AnswerTrue} ta to'g'ri va ${AnswerFalse} ta xato bajardi`;
